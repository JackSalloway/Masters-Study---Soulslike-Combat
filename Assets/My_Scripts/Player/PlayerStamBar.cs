...
{
    [SerializeField] private Slider slider; // Assigned to the player stamina slider game object

    [Header("Scipt References")]
    [SerializeField] private PlayerStamina playerStamina; // Reference to the PlayerStamina script
